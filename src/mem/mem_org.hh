...
namespace gem5 {
  ...
  typedef struct {
    ...
    Addr*   mtreeLevelsStartAddr; // Array holds the start byte_addr of each Mtree Level [0-num_Mtree_levels]
    unsigned long long*   mtreeLevelSize; // Array holds the sizes for each of the levels
